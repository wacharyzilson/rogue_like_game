...
void monster_description::build(npc *npc)
{
  npc->name = &name;
  npc->description = &description;
  npc->symbol = symbol;
  npc->color = color;
  npc->traits = abilities;
  npc->speed = (int) speed.roll();
  npc->hitpoints = (int) hitpoints.roll();
  npc->damage = &damage;
}
...
void object_description::build(object *obj)
{
  obj->name = &name;
  obj->description = &description;
  obj->symbol = object_symbol[type];
  obj->type = type;
  obj->color = color;
  obj->hit = (int) hit.roll();
  obj->dodge = (int) dodge.roll();
  obj->defence = (int) defence.roll();
  obj->weight = (int) weight.roll();
  obj->speed = (int) speed.roll();
  obj->attribute = (int) attribute.roll();
  obj->value = (int) value.roll();
  obj->damage = &damage;
  obj->next = NULL;
}
